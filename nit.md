...
On top of this, agents might want to make multiple changes before submitting for review, so they should register their entire chain, while the tool presents each commit individually.

The main page of the application should show all the chains and their current state (waiting for review or agent's turn). When one of these chains is done and the agent merges or rebases it it should be removed from the page.
