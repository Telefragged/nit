...
/// was.
///
/// The counts measure the hunks [`hunks::of_file`] came back with, so an
/// outline of a rewritten body under a surviving signature counts `+0 -0`
/// where a full diff counts its real size. The two totals measure the
